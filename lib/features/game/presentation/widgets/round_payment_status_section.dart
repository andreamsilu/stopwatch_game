...
class RoundPaymentStatusSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final message = switch (phase) {
      ...
      RoundPreparePhase.charging => RoundBillingCopy.preparingRoundCharge,

      RoundPreparePhase.awaitingPayment => RoundBillingCopy.waitingForPayment,

      RoundPreparePhase.loadingTarget => RoundBillingCopy.loadingTarget,

      RoundPreparePhase.idle => '',
